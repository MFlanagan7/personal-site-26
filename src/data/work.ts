...
export const workExperience: WorkExperience[] = [
  {
    ...
    summary:
      "Marketing technologist and HubSpot CMS developer embedded in the marketing team of a $1.5B regional credit union. Responsible for HubSpot CMS development, website management, marketing technology operations, and cross-platform web presence.",
    highlights: [
      ...
      "Sole implementer of a full website redesign: built 20+ custom HubSpot modules and 3 custom page templates, migrating content from a 250+ page legacy site into 150+ redesigned pages, working from designs produced by an external design firm",
      ...
      "Integrated AI tooling (Claude, Claude Code, Claude Design, HubSpot Breeze) into daily development workflows, accelerating HubL and JavaScript module delivery, debugging, marketing copy iteration, and design prototyping",
    ],
    skills: [
      "HubSpot CMS",
      "HubL",
